...
export function genelDurum(oda) { return { odaId: oda.odaId, odaAdi: oda.odaAdi, maksimum: oda.maksimum, kurucuSocketId: oda.kurucuSocketId, kurucuId: oda.kurucuId, oyuncular: oda.oyuncular.map(({ socketId, isim, avatar, bot, koltukNo }) => ({ socketId, isim, avatar, bot: Boolean(bot), koltukNo })), izleyiciSayisi: oda.izleyiciler.length, oyunBasladi: oda.gameState.oyunBasladi, siradakiOyuncu: oda.gameState.siradakiOyuncu, mevcutBaraj: oda.gameState.mevcutBaraj }; }
