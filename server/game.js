...
export function yeniOda(odaId, odaAdi, oyuncu) { return { odaId, odaAdi, kurucuSocketId: oyuncu.socketId, oyuncular: [], izleyiciler: [oyuncu.socketId], gameState: { oyunBasladi: false, siradakiOyuncu: 0, deste: [], gosterge: null, iskartaKutusu: [], mevcutBaraj: 101, masaZemini: { seri: [], cift: [] } } }; }
export function genelDurum(oda) { return { odaId: oda.odaId, odaAdi: oda.odaAdi, kurucuSocketId: oda.kurucuSocketId, oyuncular: oda.oyuncular.map(({ socketId, isim, koltukNo }) => ({ socketId, isim, koltukNo })), izleyiciSayisi: oda.izleyiciler.length, oyunBasladi: oda.gameState.oyunBasladi, siradakiOyuncu: oda.gameState.siradakiOyuncu, mevcutBaraj: oda.gameState.mevcutBaraj }; }
