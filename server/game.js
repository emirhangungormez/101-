...
export function yeniOda(odaId, odaAdi, oyuncu, maksimum = 4) { return { odaId, odaAdi, maksimum, kurucuSocketId: oyuncu.socketId, kurucuId: oyuncu.kullaniciId, oyuncular: [], izleyiciler: [oyuncu.socketId], gameState: { oyunBasladi: false, siradakiOyuncu: 0, deste: [], gosterge: null, iskartaKutusu: [], mevcutBaraj: 101, masaZemini: { seri: [], cift: [] } } }; }
export function genelDurum(oda) { return { odaId: oda.odaId, odaAdi: oda.odaAdi, maksimum: oda.maksimum, kurucuSocketId: oda.kurucuSocketId, kurucuId: oda.kurucuId, oyuncular: oda.oyuncular.map(({ socketId, kullaniciId, isim, avatar, bot, koltukNo }) => ({ socketId, kullaniciId, isim, avatar, bot: Boolean(bot), koltukNo })), izleyiciSayisi: oda.izleyiciler.length, oyunBasladi: oda.gameState.oyunBasladi, siradakiOyuncu: oda.gameState.siradakiOyuncu, mevcutBaraj: oda.gameState.mevcutBaraj }; }
